...
function bench(N)
    ...
    R = 6.371f6
    θ = (deg2rad(70f0), deg2rad(110f0)) # in radians 0 ≤ θ ≤ π 
    ϕ = (deg2rad(70f0), deg2rad(110f0)) # in radians 0 ≤ ϕ ≤ 2π 
    c0 = (θ[1], ϕ[1], R-2f6) # origin corner
...
function run_benchs()
    ...
    CSV.write("CPU_benchmarks_250x250x50.csv", df)
end
