...
fls = [
    "GPU_1_threads_star1_NOreorder_new.csv",
    "GPU_4_threads_star1_NOreorder_new.csv",
]
...
ax = Axis(f[1,1], xlabel="log10(nodes)", ylabel="time [s]", yscale=log10, 
    yminorticksvisible = true, yminorgridvisible = true,  yminorticks = IntervalsBetween(8)) 
